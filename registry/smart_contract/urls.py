...
urlpatterns = [
 ...
 path('registration-employee', views.RegistrationUser.as_view(form_class=forms.RegistrationEmployeeForm, success_url = reverse_lazy('django_registration_complete')), name='registration_user'),
